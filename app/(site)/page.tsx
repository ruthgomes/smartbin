...
export default function Home() {
  return (
    <div>
      {/* Hero Section */}
      <section
        className="relative bg-gradient-to-b from-green-100 to-white py-20"
        id="home"
      >
        <div className="container flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2 space-y-6">
            ...
            <p className="text-lg text-gray-700">
              A SmartBin oferece soluções inovadoras para monitoramento e gestão
              de resíduos, tornando a reciclagem mais eficiente e acessível.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-green-50 p-6 rounded-lg shadow-md border-t-4 border-green-500 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700">
                Nossas lixeiras são equipadas com sensores que monitoram o nível
                de enchimento e alertam quando precisam ser esvaziadas.
              </p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg shadow-md border-t-4 border-blue-500 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700">
                Acompanhe em tempo real a quantidade de resíduos coletados por
                tipo e otimize suas rotas de coleta.
              </p>
            </div>
            <div className="bg-yellow-50 p-6 rounded-lg shadow-md border-t-4 border-yellow-500 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700">
                Visualize o impacto positivo da sua reciclagem no meio ambiente
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="bg-white p-8 rounded-lg shadow-md border-l-4 border-green-500 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700">
                Transformar a gestão de resíduos através da tecnologia, tornando
                a reciclagem mais eficiente e acessível para todos, contribuindo
                para um planeta mais limpo e sustentável.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-md border-l-4 border-blue-500 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700">
                ...
                tecnológicas para gestão de resíduos, presente em todas as
                grandes cidades do Brasil e da América Latina até 2030.
              </p>
            </div>
      ...
      <section className="py-20 bg-gradient-to-b from-blue-50 to-white">
        <div className="container">
          ...
          <p className="text-center text-gray-700 mb-12 max-w-2xl mx-auto">
            Acompanhe a evolução do projeto SmartBin desde o início até a
